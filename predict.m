function [T, a, mse_total, std_total, r] = predict(filename, index, n_list, preprocess_flag, feature, feature_parameter, predictionNN, graphic, preprocess_graphic, feature_graphic)
...
% usage:
% paa example:
% [T, a, error_mse, error_std, r] = predict('cpu1.dat',1,64,1,'paa',32,'linear',1,0,1)
% dwt example:
% [T, a, error_mse, error_std, r] = predict('cpu1.dat',1,64,1,'dwt',5,'linear',1,0,1)
% output parameters:
% T: processed data
% a: predicted data
